...
//        ├──────┼───┼──────┼──────┼──────┼─────────────┼──────┐   ┌─────┼─────────────────┼──────┼──────┼──────┼───┼──────┤
//        │ lsft │ v │  z   │  x   │  c   │      p      │ mute │   │ no  │        ,        │  h   │  '   │  q   │ ; │  =   │
//        └──────┴───┼──────┼──────┼──────┼─────────────┼──────┤   ├─────┼─────────────────┼──────┼──────┼──────┼───┴──────┘
//                   │ lgui │ lalt │ lctl │ MO(_SYMBOL) │ spc  │   │ spc │ MO(_NAVIGATION) │ lsft │ lalt │ lctl │
//                   └──────┴──────┴──────┴─────────────┴──────┘   └─────┴─────────────────┴──────┴──────┴──────┘
[_KLUNGSMAK] = LAYOUT(
      ...
      KC_LSFT , KC_V , KC_Z    , KC_X    , KC_C    , KC_P        , KC_MUTE ,     KC_NO  , KC_COMM         , KC_H    , KC_QUOT , KC_Q    , KC_SCLN , KC_EQL ,
                       KC_LGUI , KC_LALT , KC_LCTL , MO(_SYMBOL) , KC_SPC  ,     KC_SPC , MO(_NAVIGATION) , KC_LSFT , KC_LALT , KC_LCTL
),
...
[_QWERTY] = LAYOUT(
      ...
      KC_LSFT , KC_Z , KC_X    , KC_C    , KC_V    , KC_B        , KC_MUTE ,     KC_NO  , KC_N            , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_EQL ,
                       KC_LGUI , KC_LALT , KC_LCTL , MO(_SYMBOL) , KC_SPC  ,     KC_SPC , MO(_NAVIGATION) , KC_LSFT , KC_LALT , KC_LCTL
),
...
[_SYMBOL] = LAYOUT(
      ...
      KC_TRNS , KC_LBRC , KC_LCBR , KC_EQL  , KC_UNDS , KC_LT   , KC_TRNS ,     KC_TRNS , KC_GT   , KC_PLUS     , KC_MINS , KC_RCBR , KC_RBRC , KC_TRNS,
                          KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,     KC_TRNS , MO(_FN) , MO(_NUMPAD) , KC_TRNS , KC_TRNS
),
...
//        ├─────────┼───────────────┼────────────────┼───────────────┼───────────────┼───────────────┼─────┐   ┌─────┼─────┼─────┼─────┼─────┼──────┼─────────┤
//        │   no    │      no       │       no       │     kp_/      │     kp_-      │      no       │ no  │   │ no  │ no  │  1  │  2  │  3  │  0   │   no    │
//        └─────────┴───────────────┼────────────────┼───────────────┼───────────────┼───────────────┼─────┤   ├─────┼─────┼─────┼─────┼─────┼──────┴─────────┘
//                                  │                │               │               │               │     │   │     │     │     │     │     │
//                                  └────────────────┴───────────────┴───────────────┴───────────────┴─────┘   └─────┴─────┴─────┴─────┴─────┘
[_NUMPAD] = LAYOUT(
      ...
      KC_NO   , KC_NO         , KC_NO          , KC_PSLS       , KC_PMNS       , KC_NO         , KC_NO   ,     KC_NO   , KC_NO   , KC_1    , KC_2    , KC_3    , KC_0    , KC_NO  ,
