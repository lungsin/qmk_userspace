...
[_KLUNGSMAK] = LAYOUT(
      ...
      KC_LSFT , KC_V , KC_Z    , KC_X    , KC_C    , KC_P        , KC_MUTE ,     QK_BOOT , KC_COMM         , KC_H    , KC_QUOT , KC_Q    , KC_SCLN , KC_EQL ,
...
[_QWERTY] = LAYOUT(
      ...
      KC_LSFT , KC_Z , KC_X    , KC_C    , KC_V    , KC_B        , KC_MUTE ,     QK_BOOT , KC_N            , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_EQL ,
                       KC_LGUI , KC_LALT , KC_LCTL , MO(_SYMBOL) , KC_SPC  ,     KC_SPC  , MO(_NAVIGATION) , KC_LSFT , KC_LALT , KC_LCTL
),
...
[_SYMBOL] = LAYOUT(
      ...
      KC_TRNS , KC_LBRC , KC_LCBR , KC_EQL  , KC_UNDS , KC_LT   , KC_TRNS ,     KC_TRNS , KC_GT       , KC_PLUS , KC_MINS , KC_RCBR , KC_RBRC , KC_TRNS,
                          KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,     KC_TRNS , MO(_NUMPAD) , MO(_FN) , KC_TRNS , KC_TRNS
),
